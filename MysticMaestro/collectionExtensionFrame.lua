...
--Show/Hide button in main list view
	...
	if altar then
		...
		collectionOverlay.altarBtn:SetAttribute("type", "macro")
		collectionOverlay.altarBtn:SetAttribute("macrotext", MM.db.realm.OPTIONS.selfCastAltar and "/use [@player] "..altar[1] or "/use "..altar[1])
